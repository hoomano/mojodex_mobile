...
class ChatView extends StatelessWidget {
  ...
  ChatView({required this.userWorkflowExecution, this.firstMessageToSend});

  void onResubmit(UserMessage message) {
    // userWorkflowExecution.reSubmit(message);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Center(child: Consumer<Session>(
      ...
      return Column(
        children: [
          Expanded(
            child: userWorkflowExecution.startDate == null &&
                ...
                ? Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          "userWorkflowExecution.placeholderHeader",
                          style: TextStyle(
                        ...
                        Text("userWorkflowExecution.placeholderBody",
                            style: TextStyle(
                                color: themeProvider.themeMode == ThemeMode.dark
                                    ? ds.DesignColor.white
