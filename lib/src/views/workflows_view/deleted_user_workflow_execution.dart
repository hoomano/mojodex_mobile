...
class DeletedUserWorkflowExecution extends StatelessWidget {
  const DeletedUserWorkflowExecution({Key? key}) : super(key: key);
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Uh-oh! Couldn't find that workflow. It may have been deleted or the link is off.",
                  style: TextStyle(
                      fontSize: ds.TextFontSize.h4,
                      color: themeProvider.themeMode == ThemeMode.dark
                          ? ds.DesignColor.grey.grey_1
